...
- **Run the matrix.** 80x24, 120x40, and 40 columns; a live resize; a dark and a light theme; `NO_COLOR=1`; `TERM=dumb`; stdout piped through `cat`; no Nerd Font; rows with CJK and emoji. Say which configurations produced the evidence. <!-- rule:terminal-verify-matrix -->
